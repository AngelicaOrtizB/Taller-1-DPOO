...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar país del atleta\n");
	...
	{
		System.out.println("\n" + "País de un atleta por medio de su nombre nombre" + "\n");
		String nombre= input("Ingrese el nombre del atleta");
		String PaisAtleta= calculadora.paisPorAtleta(nombre);
		System.out.println("El país del atleta ingresado es " + PaisAtleta);
	}
